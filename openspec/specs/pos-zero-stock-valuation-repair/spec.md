# POS Zero Stock Valuation Repair Specification

> [!abstract] Исправление нулевой складской оценки POS
...
#### Scenario: Preserve ordinary workflows when repair is disabled
- **WHEN** ordinary POS sales, returns, invoicing, session closure or cost recomputation run without enabling stock repair
- **THEN** their existing behavior and permissions are preserved
- **AND** ordinary cost recomputation leaves stock valuation unchanged
